...
underestimates rare large moves.</p></div>
...
<figcaption><b>02</b> · Velocity densities on a log axis against a Gaussian of the same SD. The near-linear flanks are the Laplace signature. Bottom left shows the 30-minute increment, where the rise/fall asymmetry is plain. In the rise/fall ratio each line stops where that person has fewer than 40 samples left in the tail, beyond which the curve would be tracing individual readings rather than a distribution.</figcaption></figure>
