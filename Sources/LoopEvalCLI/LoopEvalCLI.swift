...
struct LoopEvalCLI: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        version: "0.1.0",
        subcommands: [EvaluateCommand.self, CacheCommand.self, InspectCommand.self, CompareCommand.self, BenchCommand.self, ISFExploreCommand.self, ISFRollingCommand.self, ISFDiurnalCommand.self, DriftCommand.self, ReplayIssueReportCommand.self],
