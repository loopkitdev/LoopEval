...
struct LoopEvalCLI: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        version: "0.1.0",
        subcommands: [EvaluateCommand.self, CacheCommand.self, InspectCommand.self, BenchCommand.self, SimulateCommand.self, ForecastMatchCommand.self, DoseFromForecastCommand.self, InsulinEffectCheckCommand.self, CarbEffectCheckCommand.self, DoseSetCheckCommand.self],
